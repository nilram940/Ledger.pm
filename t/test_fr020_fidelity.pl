#!/usr/bin/perl
# FR-020: Ledger::CSV::Fidelity module.
# Verifies that Fidelity->config(account_map=>) produces identical results
# to the FR-015 inline config.
